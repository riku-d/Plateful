...
const foodSchema = new mongoose.Schema({
  ...
  image: { type: String }, // ✅ URL for the food image
  status: { type: String, enum: ['available', 'reserved', 'picked-up', 'delivered', 'expired', 'cancelled'], default: 'available' }, // ✅ Track donation status
